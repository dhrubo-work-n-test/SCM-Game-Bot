...
try:
    NEWS_API = "https://newsdata.io/api/1/news?apikey=pub_5063b3e9a7b8dc86a463da2c4debc5a0a2b50&q=supply%20chain&language=en&country=us"
    response = requests.get(NEWS_API)
    if response.status_code == 200:
        articles = response.json().get("results", [])[:3]
